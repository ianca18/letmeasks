...
export function Room() {
    ...
    async function handleSendQuestion(event: FormEvent) {
        ...
        if (!user) {
            throw new Error('you must be legged in');
                    ...
                    {questions.map(question => {
                        return (
                            <Question
                                ...
                                isAnswered={question.isAnswered}//mudei
                                isHighlighted={question.isHighlighted}//mudei
                            ...
                            > 
                              ...
                              {!question.isAnswered && (
                                ...
                                <button
                                    className={`like-button ${question.likeId ? 'liked' : ''}`}//atributo de acessebilidade
                                    type="button"
                                    aria-label=" marcar como gostei"
                                    onClick={() => handleLikeQuestion(question.id, question.likeId)} //funcao anonima
                                >
